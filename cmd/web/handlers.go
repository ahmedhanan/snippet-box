...
func home(w http.ResponseWriter, r *http.Request) {
	...
	files := []string{"./ui/html/pages/base.tmpl", "./ui/html/pages/nav.tmpl","./ui/html/pages/home.tmpl"}

	ts, err := template.ParseFiles(files...)
	if err != nil {
		log.Print(err.Error())
		http.Error(w, "Internal error for server", http.StatusInternalServerError)
		return
	}
